...
public class PermissionService {
	...
	public PermissionResponse getPermissionById(Long id) {
		Permission permission= permissionRepository.findById(id).orElseThrow(()->new RuntimeException("Permission không tồn tại"));
	...
	public PermissionResponse update(UpdatePermissionRequest request) {
		Permission updatePermission =permissionRepository.findById(request.getId()).orElseThrow(()-> new RuntimeException("Permission không tồn tại"));
		Permission checkPermission = permissionRepository.findByName(request.getName());
		if(checkPermission!=null) {
			throw new RuntimeException("Permission đã tồn tại");
		}
